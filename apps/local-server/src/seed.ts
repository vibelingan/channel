...
const PRODUCTS: Record<string, unknown>[] = [
  ...
  {
    name: 'Local Demo VisionClip AI Camera',
    productFamily: 'ai-gadgets',
    skuCode: 'AI-VC-100',
    slug: 'local-demo-visionclip-ai-camera',
    archived: false,
    description: 'Synthetic local-only AI camera fixture for family browsing and detail testing.',
    moq: 100,
    unitPrice: 24,
    wholesalePrice: 19,
  ...
  {
    name: 'Local Demo Pocket Translator',
    productFamily: 'ai-gadgets',
    skuCode: 'AI-PT-200',
    slug: 'local-demo-pocket-translator',
    archived: false,
    description: 'Synthetic local-only translation device fixture with offline demo content.',
    moq: 200,
    unitPrice: 31,
    wholesalePrice: 25,
  ...
  {
    name: 'Local Demo BuildBot Kit',
    productFamily: 'toys',
    skuCode: 'TY-BB-100',
    slug: 'local-demo-buildbot-kit',
    archived: false,
    description: 'Synthetic local-only educational robot kit fixture for the Toys family.',
    moq: 300,
    unitPrice: 12,
    wholesalePrice: 9,
  ...
  {
    name: 'Local Demo Magnetic Tiles',
    productFamily: 'toys',
    skuCode: 'TY-MT-200',
    slug: 'local-demo-magnetic-tiles',
    archived: false,
    description: 'Synthetic local-only magnetic construction set fixture for catalog testing.',
    moq: 500,
    unitPrice: 8,
    wholesalePrice: 6,
  ...
  {
    name: 'Local Demo USB-C Travel Hub',
    productFamily: 'misc',
    skuCode: 'MI-HUB-100',
    slug: 'local-demo-usb-c-travel-hub',
    archived: false,
    description: 'Synthetic local-only multiport travel hub fixture for miscellaneous electronics.',
    moq: 250,
    unitPrice: 10,
    wholesalePrice: 7.5,
  ...
  {
    name: 'Local Demo Desktop Aroma Light',
    productFamily: 'misc',
    skuCode: 'MI-AL-200',
    slug: 'local-demo-desktop-aroma-light',
    archived: false,
    description: 'Synthetic local-only desktop light fixture for miscellaneous family layouts.',
    moq: 200,
    unitPrice: 9,
    wholesalePrice: 6.8,
