...
- 2026-07-27: **Route contract superseded 2026-07-27** by later main commit `90bd06e`: `/headphones` was restored to public navigation and HTTP 200; `/overstock` remains retired and HTTP 404. Earlier entries recording both routes as 404 remain historical evidence for the 2026-07-23 delivery SHA, not current acceptance instructions.
