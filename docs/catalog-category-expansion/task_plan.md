...
| 17. Implement catalog content registry | In progress | MIU 9 family metadata and asset contract active |
| 18. Implement remaining V1.1 MIUs | Pending | MIU 10-22 execute in dependency order |
