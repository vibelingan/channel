...
Status: approved architecture baseline; MIUs 01-18 released; no active exact reservations; MIU 19 planned.
...
Verify live local/remote equality before declaring publication; historical checkpoints do not establish it.
