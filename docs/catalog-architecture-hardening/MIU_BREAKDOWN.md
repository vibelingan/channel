...
- No MIU or exact file is active. MIUs 01-18 are released; MIU 19 is planned; MIUs 26-28 remain blocked by D1.
...
- **Reservation state:** `released`; previous state `active`. Media-state and SSR/hydration validation was local only.
- **What it does:**
...
- **Reservation state:** `released`; previous state `active`. Metadata/JSON-LD and production-origin validation was local only.
- **What it does:**
...
- **Type:** new-file
- **Depends on:** MIU 15
- **Reservation state:** `released`; previous state `active`; reviewed source `134e62d` pushed and verified. Later adapters consume `apps/site/src/i18n/catalog.ts` read-only.
- **What it does:**
...
- **Reservation state:** `released`; previous state `active`; reviewed source `fc01b48` pushed and verified. `apps/site/src/i18n/catalog.ts` remains read-only.
- **What it does:**
