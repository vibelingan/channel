...
Status: 49-MIU packet published; MIUs 01-04 released; MIU 05 active for local validation; MIU 06 planned and inactive.
...
- MIU 05 is active for local browser/SSR validation with three exact owner files. Future MIU plans have
	lifecycle state and exact owner files, with references/transfers for sequential reuse.
