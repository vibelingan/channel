...
Status: 49-MIU packet published; MIUs 01-06 released; MIU 07 active for local validation; MIU 08 planned and inactive.
...
- MIU 07 is active for local validation with three exact owner files. Future MIU plans have lifecycle
