...
Status: 49-MIU packet published; MIUs 01-13 released; MIU 14 active for local implementation and validation.
...
- MIU 14 is the sole active exact-file claim. Future MIU plans have lifecycle state and exact owner
