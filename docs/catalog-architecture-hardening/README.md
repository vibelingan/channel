...
Status: 49-MIU packet published; MIUs 01-07 released; MIU 08 active for local validation; MIU 09 planned and inactive.
...
- MIU 08 is active for local validation with two exact owner files. Future MIU plans have lifecycle state
	and exact owner files, with references/transfers for sequential reuse.
