...
Status: 49-MIU packet published; MIUs 01-11 released; MIU 12 active for local implementation and validation.
...
- MIU 12 is the sole active exact-file claim. Future MIU plans have lifecycle state and exact owner
