...
Status: 49-MIU packet published; MIUs 01-12 released; MIU 13 active for local implementation and validation.
...
- MIU 13 is the sole active exact-file claim. Future MIU plans have lifecycle state and exact owner
