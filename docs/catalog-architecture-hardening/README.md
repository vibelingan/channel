...
Status: 49-MIU packet published; MIUs 01-05 released; MIU 06 active for local validation; MIU 07 planned and inactive.
...
- MIU 06 is active for local validation with three exact owner files. Future MIU plans have lifecycle
