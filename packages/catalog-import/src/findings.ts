...
export const FINDING_CODES = {
  ...
  // Which rung of the fallback chain supplied the description
  // (APPROVED_DESIGN_SPEC §11). Separate codes rather than one code with a
  // level, so a job summary groups them without anyone parsing a message.
  DESCRIPTION_FALLBACK_SHORT: 'DESCRIPTION_FALLBACK_SHORT',
  DESCRIPTION_FALLBACK_STRUCTURED: 'DESCRIPTION_FALLBACK_STRUCTURED',
  DESCRIPTION_FALLBACK_TITLE_ONLY: 'DESCRIPTION_FALLBACK_TITLE_ONLY',
  DESCRIPTION_MISSING: 'DESCRIPTION_MISSING',
  GALLERY_TRUNCATED: 'GALLERY_TRUNCATED',
